...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .user-name { color: #85358c; font-size: 0.85em; }
        .page-header { padding: 60px 60px 30px; border-bottom: 1px solid #e5c6f6; display:flex; align-items:center; gap:20px; background: #fff; border-radius: 16px 16px 0 0; }
        ...
        .page-header-title p { color: #85358c; font-size: 0.95em; }
        .container { max-width: 1400px; margin: 0 auto; padding: 40px 60px 60px; background: #fff; border-radius: 0 0 16px 16px; box-shadow: 0 2px 12px #e5c6f6; }
        .products-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 30px; }
        .product-card { background: #f3e6fa; border: 1px solid #85358c; transition: border-color 0.3s; cursor: pointer; }
        .product-card:hover { border-color: #4b1556; }
        .product-image { height: 260px; background: #e5c6f6; display: flex; justify-content: center; align-items: center; overflow: hidden; position: relative; }
        .product-image img { max-width: 100%; max-height: 100%; object-fit: cover; }
        .product-placeholder { font-size: 3em; color: #e5c6f6; }
        .product-info { padding: 20px; text-align: center; }
        .product-name { font-size: 0.95em; font-weight: 500; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 8px; color: #4b1556; }
        .product-rating { font-size: 0.8em; color: #f39c12; margin-bottom: 8px; }
        .product-price { font-size: 1em; color: #4b1556; margin-bottom: 12px; }
        .add-to-cart-btn { width: 100%; padding: 12px; background: #85358c; color: #fff; border: none; font-size: 0.8em; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; cursor: pointer; transition: background 0.3s; }
        .add-to-cart-btn:hover { background: #4b1556; }
        .no-products { text-align: center; padding: 80px; color: #85358c; }
