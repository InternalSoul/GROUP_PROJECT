...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cart-empty { text-align: center; padding: 80px 40px; background: #fff; border: 1px solid #9d4aa3; }
        .cart-empty h2 { font-family: 'Playfair Display', serif; font-size: 1.5em; font-weight: 400; margin-bottom: 15px; color: #85358c; }
        .cart-empty p { color: #b4838d; margin-bottom: 30px; }
        .cart-empty a { display: inline-block; padding: 16px 40px; background: #85358c; color: #fff; text-decoration: none; font-size: 0.85em; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; transition: background 0.3s; }
        .cart-empty a:hover { background: #6b2a70; }
        .cart-items { background: #fff; border: 1px solid #9d4aa3; border-radius: 8px; overflow: hidden; }
        ...
        .cart-item:hover { background: #f5e6fa; }
        .cart-item:last-child { border-bottom: none; }
        .item-image { width: 100px; height: 100px; background: #f5e6fa; display: flex; justify-content: center; align-items: center; margin-right: 30px; font-size: 2em; color: #b4838d; overflow: hidden; }
        .item-image img { max-width: 100%; max-height: 100%; object-fit: cover; }
        .item-details { flex: 1; }
        .item-name { font-size: 1em; font-weight: 500; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 8px; color: #85358c; }
        .item-price { color: #85358c; font-size: 1.1em; }
        .item-qty { color: #b4838d; font-size: 0.9em; margin-top: 4px; }
        .remove-btn { padding: 12px 24px; background: transparent; color: #85358c; border: 1px solid #85358c; font-size: 0.8em; font-weight: 500; letter-spacing: 1px; text-transform: uppercase; cursor: pointer; transition: all 0.3s; }
        .remove-btn:hover { background: #85358c; color: #fff; }
        .cart-summary { background: #fff; border: 1px solid #9d4aa3; padding: 40px; margin-top: 30px; }
        .summary-row { display: flex; justify-content: space-between; margin-bottom: 15px; font-size: 1em; color: #85358c; }
        .summary-row.total { font-size: 1.3em; font-weight: 600; padding-top: 20px; border-top: 1px solid #9d4aa3; margin-top: 20px; color: #85358c; }
        .checkout-btn { display: block; width: 100%; padding: 18px; background: #85358c; color: #fff; text-align: center; text-decoration: none; font-size: 0.85em; font-weight: 600; letter-spacing: 2px; text-transform: uppercase; margin-top: 25px; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); border: none; cursor: pointer; position: relative; overflow: hidden; }
        .checkout-btn::before { content: ''; position: absolute; top: 50%; left: 50%; width: 0; height: 0; border-radius: 50%; background: rgba(212,175,55,0.15); transform: translate(-50%, -50%); transition: width 0.6s, height 0.6s; }
        .checkout-btn:hover { background: #6b2a70; transform: translateY(-2px); box-shadow: 0 10px 25px rgba(133,53,140,0.2); }
        .checkout-btn:hover::before { width: 400px; height: 400px; }
        .checkout-btn:active { transform: translateY(0); }
        .continue-shopping { display: block; text-align: center; margin-top: 20px; color: #b4838d; text-decoration: none; font-size: 0.9em; }
        .continue-shopping:hover { color: #85358c; }
        ...
        .footer p { color: #d4af37; font-size: 0.8em; }        .breadcrumbs { font-size: 0.85em; color: #b4838d; margin-bottom: 20px; }
        .breadcrumbs a { color: #85358c; text-decoration: none; transition: opacity 0.3s; }
