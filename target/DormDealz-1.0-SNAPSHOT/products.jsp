...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page-header { padding: 60px 60px 40px; text-align: center; border-bottom: 1px solid #e5e5e5; }
        .page-header h1 { font-family: 'Playfair Display', serif; font-size: 2.8em; font-weight: 400; letter-spacing: 3px; margin-bottom: 10px; color: #85358c; }
        .page-header p { color: #9d4aa3; font-size: 1em; letter-spacing: 1px; }
        .search-section { padding: 30px 60px; background: #f5f0f6; border-bottom: 1px solid #e5e5e5; }
        ...
        .search-main-row input[type="text"]:focus { outline: none; border-color: #85358c; }
        .search-main-row select { padding: 14px 16px; border: 1px solid #d4af37; font-size: 0.9em; font-family: 'Inter', sans-serif; background: #fff; cursor: pointer; }
        .search-main-row select:focus { outline: none; border-color: #85358c; }
        .search-main-row button[type="submit"] { padding: 14px 24px; background: #85358c; color: #fff; border: none; font-size: 0.8em; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; cursor: pointer; transition: background 0.3s; }
        .search-main-row button[type="submit"]:hover { background: #6b2a70; }
        .clear-link { font-size: 0.8em; text-transform: uppercase; letter-spacing: 1px; color: #85358c; text-decoration: none; padding: 0 6px; }
        .clear-link:hover { text-decoration: underline; color: #6b2a70; }
        .filter-toggle { display: inline-flex; align-items: center; gap: 6px; padding: 12px 16px; border: 1px solid #85358c; background: #fff; cursor: pointer; letter-spacing: 1px; text-transform: uppercase; font-size: 0.75em; font-weight: 600; transition: background 0.2s, color 0.2s; color: #85358c; }
        .filter-toggle:hover { background: #85358c; color: #fff; }
        ...
        .filters-panel select { padding: 14px 16px; border: 1px solid #d4af37; font-size: 0.9em; font-family: 'Inter', sans-serif; background: #fff; cursor: pointer; }
        .filters-panel select:focus { outline: none; border-color: #85358c; }
        ...
        .product-card { background: #fff; border: 1px solid #9d4aa3; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); cursor: pointer; opacity: 0; animation: fadeInUp 0.6s ease-out forwards; border-radius: 8px; overflow: hidden; }
        ...
        .product-card:hover { border-color: #85358c; transform: translateY(-8px); box-shadow: 0 20px 40px rgba(133,53,140,0.12); }
        ...
        .product-placeholder { font-size: 4em; color: #b4838d; }
        .product-badge { position: absolute; top: 10px; right: 10px; background: #85358c; color: #fff; padding: 4px 8px; font-size: 0.65em; font-weight: 600; text-transform: uppercase; }
        .product-info { padding: 25px; text-align: center; }
        .product-name { font-size: 0.95em; font-weight: 500; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 10px; color: #85358c; }
        ...
        .seller-link { display: inline-flex; align-items: center; gap: 6px; color: #85358c; font-size: 0.78em; letter-spacing: 0.5px; text-transform: uppercase; text-decoration: none; }
        .seller-link:hover { text-decoration: underline; color: #6b2a70; }
        .product-rating { font-size: 0.8em; color: #f39c12; margin-bottom: 10px; }
        .product-price { font-size: 1em; color: #85358c; margin-bottom: 20px; }
        .details-link { display: inline-block; margin-bottom: 12px; font-size: 0.8em; letter-spacing: 1px; text-transform: uppercase; color: #85358c; text-decoration: none; border: 1px solid #85358c; padding: 10px 14px; transition: background 0.3s, color 0.3s; }
        .details-link:hover { background: #85358c; color: #fff; }
        .add-to-cart-btn { width: 100%; padding: 14px; background: #85358c; color: #fff; border: none; font-size: 0.8em; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; cursor: pointer; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden; }
        .add-to-cart-btn::before { content: ''; position: absolute; top: 50%; left: 50%; width: 0; height: 0; border-radius: 50%; background: rgba(212,175,55,0.15); transform: translate(-50%, -50%); transition: width 0.6s, height 0.6s; }
        .add-to-cart-btn:hover { background: #6b2a70; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(133,53,140,0.2); }
        .add-to-cart-btn:hover::before { width: 300px; height: 300px; }
        .add-to-cart-btn:active { transform: translateY(0); }
        .no-products { text-align: center; padding: 80px; color: #b4838d; }
        .no-products h2 { font-family: 'Playfair Display', serif; font-size: 1.8em; font-weight: 400; margin-bottom: 15px; color: #85358c; }
        ...
        .footer { background: #85358c; color: #fff; padding: 50px 60px; margin-top: 60px; text-align: center; }
        .footer-logo { font-family: 'Playfair Display', serif; font-size: 1.5em; letter-spacing: 3px; margin-bottom: 20px; color: #fff; }
